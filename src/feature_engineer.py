...
class FeatureEngineer:
    ...
    def _apply_multiview_fusion(self, features: pd.DataFrame) -> pd.DataFrame:
        ...
        if view1_data.shape[0] < 2 or view2_data.shape[0] < 2:
            self.logger.warning(f"Not enough samples for CCA (view1: {view1_data.shape[0]}, view2: {view2_data.shape[0]}). Returning original features.")
            return features
